...
def _create_binary_class_predictions_df(estimator_name, _auc, auc_std):
    predictions_df = pd.DataFrame({
        'with_oligos':feature_manager.with_oligos, 'with_additional_features':feature_manager.with_additional_features,
        'with_run_plates':feature_manager.with_run_plates,
        'data_type':feature_manager.oligos_handler.data_type,
        'subgroup':feature_manager.subgroup,
        'prevalence_threshold_min': feature_manager.prevalence_threshold_min,
        'prevalence_threshold_max':feature_manager.prevalence_threshold_max,
        'estimator': estimator_name,
        'subgroup_name': config.subgroups_to_name.get(feature_manager.subgroup),
    ...
    predictions_df = predictions_df.set_index(
        ['with_oligos', 'with_additional_features', 'with_run_plates',
         'data_type', 'subgroup',
         'prevalence_threshold_min', 'prevalence_threshold_max'],
         #'estimator', 'subgroup_name', 'auc', 'std'], #, 'num_features', 'num_oligos'],
        append=True)
...
if __name__ == '__main__':
    ...
    joblib.dump(results, f'classif_nestedCV_bestmodel_{random_seed}.joblib')
